...
Stream<List<Map<String, dynamic>>> fetchAvailableOrders() {
  return FirebaseFirestore.instance
    ...
    for (var doc in querySnapshot.docs) {
      ...
      final sellerContact = sellerData != null &&
              (sellerData['contactNumber']?.toString().isNotEmpty ?? false)
...
// this is the rider home, my idea as of now is show available products that can be delivered
  ...
  children: [
    ...
    Expanded( // This makes the list scrollable and avoids pixel overflow
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        navPush(
                          context,
                          DeliveryDetails(data: product, isDelivery: false),
                        );
                      },
                      child: Card(
                        elevation: 2,
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      product['customerAddress'] ?? 'No Customer Address',
                                      style: const TextStyle(
                                        fontSize: 14,
                                        color: Colors.orange,
                                        fontWeight: FontWeight.bold,
