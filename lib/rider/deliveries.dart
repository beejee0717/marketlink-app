          ...
          child: Column(
            children: [
              TabBar(
                ...
                indicatorColor: currentEvent == AppEvent.none? AppColors.primary: backgroundColor(currentEvent),
                labelColor: currentEvent == AppEvent.none? AppColors.primary: backgroundColor(currentEvent),
