...
late AppEvent currentEvent = getCurrentEvent();
                      ...
                      child: Column(
                        ...
                        Align(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          const CustomText(
                                            textLabel: 'Successful Deliveries:',
                                            fontSize: 15,
                                          ),
                                          StreamBuilder<int>(
                                            stream: deliveriesCount(userId),
                          ...
                          editableTextField(
                            ...
                            hintText: 'Please Add Your Address',
                            hinstyle: addressController.text.isEmpty
                                ? const TextStyle(color: Colors.red)
                                : null,
                            onToggle: () => setState(
                                () => isEditingAddress = !isEditingAddress),
                            onSave: () =>
                                saveField('address', addressController.text),
                          ),
                          editableTextField(
  ...
  Stream<int> deliveriesCount(String? riderId) {
 ...
 void saveField(String field, String value) async {
    ...
    if (uid != null) {
      ...
      final updatedUser = userProvider.user!.copyWith(
        ...
        address: field == 'address' ? value : userProvider.user!.address,
        contactNumber:
